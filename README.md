...
[![Maven Central](https://maven-badges.herokuapp.com/sonatype-central/es.urjc.etsii.grafo/mork/badge.svg?style=square)](https://search.maven.org/artifact/es.urjc.etsii.grafo/mork) 
...
- [Determining good solutions and validating them with a metaheuristic approach in social network influence minimization problems (I. Lozano-Osorio, J. Sánchez-Oro, and K. Sörensen, 2025)](https://doi.org/10.1016/j.ejor.2025.11.024).
