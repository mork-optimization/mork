package es.urjc.etsii.grafo.flayouts.experiment;
...
public class SfmrflpExplorationFilter extends ExplorationFilter {

    private static Logger log = org.slf4j.LoggerFactory.getLogger(SfmrflpExplorationFilter.class);
    private record ClassPair(Class<?> a, Class<?> b) {}
    private final Set<ClassPair> blockedRelationships = new HashSet<>();

    public SfmrflpExplorationFilter() {
