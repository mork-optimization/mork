...
public class VrpodExplorationFilter extends ExplorationFilter {

    private static Logger log = org.slf4j.LoggerFactory.getLogger(VrpodExplorationFilter.class);
    private record ClassPair(Class<?> a, Class<?> b) {}
    private final Set<ClassPair> blockedRelationships = new HashSet<>();

    public VrpodExplorationFilter() {
