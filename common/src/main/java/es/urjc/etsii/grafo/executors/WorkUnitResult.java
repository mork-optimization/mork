...
public record WorkUnitResult<S extends Solution<S, I>, I extends Instance>(String experimentName, Algorithm<S,I> algorithm, String iteration, S solution, long executionTime, long timeToTarget, MetricsStorage metrics) {
    public WorkUnitResult(String experimentName, Algorithm<S,I> algorithm, int iteration, S solution, long executionTime, long timeToTarget, MetricsStorage metrics){
