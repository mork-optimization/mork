...
solver:
  ...
  ## Minimum number of experiments to run.
...
# IRACE integration configuration. To enable IRACE tuning mode, run with --irace or --autoconfig.
irace:
  # Note: The 'enabled' property is deprecated and no longer used.
  # Use --irace or --autoconfig to activate IRACE tuning mode, or --follower for controller-only mode.
  # enabled: false
