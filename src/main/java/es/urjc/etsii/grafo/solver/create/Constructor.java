...
public abstract class Constructor<M extends Move<S,I>, S extends Solution<I>, I extends Instance> {
     ...
     */
    public abstract S construct(Instance i, SolutionBuilder builder, ConstructiveNeighborhood<M, S, I> neighborhood);
