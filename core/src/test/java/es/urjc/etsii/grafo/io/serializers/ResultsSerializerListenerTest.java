...
public class ResultsSerializerListenerTest {
    ...
    public void prepareMocks(@TempDir Path temp) {
        ...
        when(this.serializer1.getConfig()).thenReturn(new TestSerializerConfig(true, AbstractResultSerializerConfig.Frequency.PER_INSTANCE, temp));
        ...
        when(this.serializer2.getConfig()).thenReturn(new TestSerializerConfig(true, AbstractResultSerializerConfig.Frequency.EXPERIMENT_END, temp));
        ...
        when(this.serializer3.getConfig()).thenReturn(new TestSerializerConfig(false, AbstractResultSerializerConfig.Frequency.EXPERIMENT_END, temp));
