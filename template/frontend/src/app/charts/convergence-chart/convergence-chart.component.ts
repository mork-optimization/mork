...
import {ConvergenceChartConfig} from "./ConvergenceChartConfig";

@Component({
  selector: 'app-convergence-chart',
  templateUrl: './convergence-chart.component.html',
  styleUrls: [
    './convergence-chart.component.css'
  ]
})
export class ConvergenceChartComponent {
  ...
  @Input()
  set config(value: ConvergenceChartConfig) {
    this._config = {
      id: "chart-convergence-" + value.instance_name,
      options: {
        chart: {
          zoomType: 'x'
        },
